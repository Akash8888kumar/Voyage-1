...
<head>
    ...
    <title>Naveen Kundu | Voyage 1 DMC</title>
    <meta content="Naveen Kundu — Chairman &amp; CEO at Voyage 1 DMC." name="description" />
...
<body class="page-profile">
    ...
    <main>
        <section class="management-profile">
            <div class="container management-profile-grid">
                <div class="management-profile-portrait"><img alt="Naveen Kundu" loading="eager"
                        src="assets/images/team/naveen-3-1-rr9y7i3cka872do3iychh1vy80m10kdttr1pfmk4ew.png" /></div>
                <div class="management-profile-content">
                    <div class="management-profile-role">Chairman &amp; CEO</div>
                    <h1>Naveen Kundu</h1>
                    <div aria-label="Naveen Kundu social media" class="management-profile-socials"><a
                            aria-label="Naveen Kundu on Instagram" href="https://www.instagram.com/naveenkunduofficial/"
                            rel="noopener noreferrer" target="_blank" title="Instagram"><svg aria-hidden="true"
                                viewbox="0 0 24 24">
                                <rect height="18" rx="5" width="18" x="3" y="3"></rect>
                                <circle cx="12" cy="12" r="4"></circle>
                                <circle cx="17.5" cy="6.5" r="1"></circle>
                            </svg></a><a aria-label="Naveen Kundu on LinkedIn"
                            href="https://www.linkedin.com/in/naveen-kundu-628ab511/" rel="noopener noreferrer"
                            target="_blank" title="LinkedIn"><svg aria-hidden="true" viewbox="0 0 24 24">
                            ...
                            href="https://www.facebook.com/naveen.kundu.568/" rel="noopener noreferrer" target="_blank"
                            title="Facebook"><svg aria-hidden="true" class="facebook-glyph" viewBox="0 0 24 24">
                                <path
                                    d="M13.7 21v-8h2.7l.4-3h-3.1V8.1c0-.9.2-1.5 1.6-1.5H17V4c-.3 0-1.3-.1-2.4-.1-2.4 0-4 1.5-4 4.1v2H8v3h2.6v8h3.1Z">
                                </path>
                            </svg></a></div>
                    <div class="management-profile-bio">
                        <p>Naveen Kundu is a distinguished entrepreneur, business leader, author, and tourism strategist
                            with over 35 years of experience across travel, tourism, hospitality, corporate travel,
                            destination management, and the MICE industry. A two-time National Tourism Award winner, he
                            is widely recognized as one of India’s leading tourism professionals.</p>
                        <p>Before joining Voyage 1 as Chairman, Naveen founded Leisure Tours in 1997, which grew into
                            Leisure Corp—one of India’s leading travel and destination management companies. He later
                            led the strategic merger of Leisure Corp with Mercury Travels, culminating in their
                            acquisition by Ebix Inc. As Managing Director for India, the Middle East, and Southeast Asia
                            at EbixCash Travel Services, he played a pivotal role in expanding the business across
                            multiple markets.</p>
                        <p>Naveen is also the founder of Tourism Futures.AI, an AI-driven tourism marketing company
                            focused on helping travel brands leverage technology for growth.</p>
                        <p>As Chairman of Voyage 1, following his acquisition of a majority stake in the company, Naveen
                            is driving its global vision by combining decades of destination management expertise with
                            innovation, strategic partnerships, and a technology-led approach to empower travel partners
                            and accelerate the company’s international growth.</p>
                        <p>He also serves as Chairman of the FICCI Business Travel, MICE &amp; Tourism Committee, is a
                            Board Member of the Indian Convention Promotion Bureau (ICPB), and is the author of
                            Reclaiming Incredible, a book on the future of Indian tourism.</p>
                    </div>
                </div>
            </div>
        </section>
