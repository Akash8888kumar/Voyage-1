...
<head>
    ...
    <title>Azerbaijan DMC | Voyage 1 DMC</title>
    <meta
        content="As a trusted Azerbaijan DMC, Voyage 1 delivers local expertise, seamless operations and tailored travel programs for FIT, groups, luxury, MICE and corporate travel across Azerbaijan."
        name="description" />
    <style>
        .page-azerbaijan .hero-bg {
            background-image: url('assets/images/hero-azerbaijan.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .uae-image-dmc {
            background-image: linear-gradient(180deg, rgba(22, 42, 75, .04), rgba(22, 42, 75, .12)), url('assets/images/Azerbaijan__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-1 {
            background-image: url('assets/images/hero-azerbaijan.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-2 {
            background-image: url('assets/images/Azerbaijan__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-3 {
            background-image: url('assets/images/azerbaijan-city.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-4 {
            background-image: url('assets/images/azerbaijan-night.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-5 {
            background-image: url('assets/images/Azerbaijan__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-6 {
            background-image: url('assets/images/hero-azerbaijan.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-7 {
            background-image: url('assets/images/azerbaijan-city.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-8 {
            background-image: url('assets/images/azerbaijan-night.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-9 {
            background-image: url('assets/images/Azerbaijan__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-10 {
            background-image: url('assets/images/azerbaijan-city.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-11 {
            background-image: url('assets/images/Azerbaijan__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-12 {
            background-image: url('assets/images/hero-azerbaijan.webp') !important;
            background-size: cover;
            background-position: center;
        }
    ...
    <style>
        ...
        .page-azerbaijan .uae-image-dmc {
            background-image: linear-gradient(180deg, rgba(22, 42, 75, .04), rgba(22, 42, 75, .12)), url('assets/images/azerbaijan-partner.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-1 {
            background-image: url('assets/images/azerbaijan-baku-destination-card-new.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-2 {
            background-image: url('assets/images/azerbaijan-qabala-gabala-destination-card-new.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-3 {
            background-image: url('assets/images/azerbaijan-sheki-destination-card-new.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-4 {
            background-image: url('assets/images/azerbaijan-gobustan-destination-card-new.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-5 {
            background-image: url('assets/images/azerbaijan-qabala-itinerary.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-6 {
            background-image: url('assets/images/azerbaijan-shamakhi-destination-card-new.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .vo-inline-bg-7 {
            background-image: url('assets/images/azerbaijan-absheron-destination-card-new.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-azerbaijan .feature-main {
            background-image: url('assets/images/azerbaijan-baku-luxury.webp') !important;
        }

        .page-azerbaijan .feature-small:nth-child(1) {
            background-image: url('assets/images/azerbaijan-card2.webp') !important;
        }

        .page-azerbaijan .feature-small:nth-child(2) {
            background-image: url('assets/images/azerbaijan-card3.webp') !important;
        }
    </style>
...
<body class="page-destination page-azerbaijan">
    ...
    <section class="hero" data-aos="fade-up" data-aos-duration="850">
        ...
        <div class="container">
            <div class="hero-content">
                <div class="eyebrow">Voyage 1 DMC • Azerbaijan</div>
                <h1><span class="hero-dmc-name">Azerbaijan DMC</span><span class="hero-dmc-tagline">Where Heritage Meets
                        The Caspian</span></h1>
                <!-- OLD CONTENT — Azerbaijan Excel row 2 / Hero paragraph: <p>Azerbaijan combines the energy of Baku, Caspian Sea experiences, ancient heritage, mountain scenery and distinctive cuisine. Voyage 1 creates polished B2B itineraries for leisure, groups, luxury, MICE and incentive travel.</p> -->
                <p>From Baku’s contemporary energy and Caspian waterfront to Silk Road heritage, Caucasus landscapes and
                    distinctive cuisine, Voyage 1 creates seamless B2B programs across Azerbaijan for leisure, luxury,
                    groups and MICE.</p>
                <div class="hero-actions"><a class="btn primary d-inline-flex align-items-center justify-content-center"
        ...
        <div class="container two">
            <div class="row g-4 g-lg-5 align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="eyebrow">Azerbaijan Destination Management</div>
                    <h2>Your Local Partner in Azerbaijan</h2>
                    ...
                    <p>You know your clients. We know the destination. Together, we turn travel briefs into seamless
                        ...
                        on the ground.</p>
                    <!-- OLD LOCAL PARTNER COPY — <p>From Baku city breaks and cultural touring to mountain retreats, wellness stays and incentive programs, our local team brings together hotels, transportation, guides and experiences with dependable on-ground support.</p> -->
                    ...
                    <a class="btn btn-dark d-inline-flex align-items-center justify-content-center" href="#contact">Talk
                        to Our Azerbaijan Team</a>
                </div>
                <div aria-label="Azerbaijan destination scene"
    ...
    <section class="section light" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>One Destination. Remarkably Diverse Experiences.</h2>
                <!-- OLD CONTENT — Azerbaijan Excel row 3 / Why Choose Azerbaijan section intro: <p>Culture, nature, adventure, hospitality and memorable experiences in one destination.</p> -->
                <p>Ancient heritage, contemporary luxury, mountain escapes, Caspian experiences and exceptional cuisine
                    come together to create a destination with plenty to discover.</p>
            </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Culture</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 4 / Why Choose Azerbaijan / Culture: <p>Ancient heritage, museums and historic architecture.</p> -->
                            <p>Ancient heritage, fascinating museums and distinctive architecture.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Luxury</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 5 / Why Choose Azerbaijan / Luxury: <p>Premium hotels, dining and private experiences.</p> -->
                            <p>Exceptional hotels, refined dining and private experiences.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Nature</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 6 / Why Choose Azerbaijan / Nature: <p>Caucasus landscapes, forests and mountain retreats.</p> -->
                            <p>Caucasus landscapes, forests and spectacular mountain escapes.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Family</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 7 / Why Choose Azerbaijan / Family: <p>Attractions and easy-paced experiences for families.</p> -->
                            <p>Engaging attractions and easy-paced experiences for families.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>MICE</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 8 / Why Choose Azerbaijan / MICE: <p>Modern venues and memorable incentive programs.</p> -->
                            <p>Modern venues and memorable incentive experiences.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                <div class="eyebrow">Explore Azerbaijan</div>
                <h2>Discover Azerbaijan</h2>
                <!-- OLD CONTENT — Azerbaijan Excel row 9 / Discover Azerbaijan intro: <p>Signature destinations and experiences to build into every itinerary.</p> -->
                <p>“From Baku’s cosmopolitan energy to mountain retreats, Silk Road towns and ancient landscapes,
                    discover the destinations that reveal Azerbaijan’s many different sides.”</p>
            </div>
            <div class="cards row g-4">
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Baku</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 10 / Discover Azerbaijan / Baku: <p>Caspian waterfront, Old City, architecture and dining.</p> -->
                            <p>Caspian waterfronts, Old City charm, striking architecture and exceptional dining.</p><a
                                class="link" href="#services">Explore Baku →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        <div class="card-img vo-inline-bg-2" data-aos="fade-up" data-aos-delay="80"
                            data-aos-duration="750"></div>
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <!-- OLD CONTENT — Azerbaijan Excel row 11 / Discover Azerbaijan card heading Qabala/Gabala: <h3>Qabala</h3> -->
                            <h3>Qabala/ Gabala</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 11 / Discover Azerbaijan / Qabala: <p>Mountain scenery, resorts and outdoor activities.</p> -->
                            <p>Forests, lakes, elegant resorts cable cars and spectacular mountain escapes.</p><a
                                class="link" href="#services">Explore Qabala →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Sheki</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 12 / Discover Azerbaijan / Sheki: <p>Historic Silk Road heritage, crafts and cuisine.</p> -->
                            <p>Silk Road heritage, intricate crafts and distinctive local cuisine.</p><a class="link"
                                href="#services">Explore Sheki →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Gobustan</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 13 / Discover Azerbaijan / Gobustan: <p>Rock art, landscapes and ancient cultural sites.</p> -->
                            <p>Ancient rock art, dramatic landscapes and fascinating cultural heritage.</p><a
                                class="link" href="#services">Explore Gobustan →</a>
                        </div>
                    </div>
                </div>
                <!-- OLD CONTENT — Azerbaijan Excel row 14 / Duplicate Gabala card removed because Qabala and Gabala are the same: <div class="col-12 col-sm-6 col-lg-4"><div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
<div class="card-img vo-inline-bg-5" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750"></div>
<div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
<h3>Gabala</h3>
<p>Forests, lakes, cable cars and mountain recreation.</p><a class="link" href="#services">Explore Gabala →</a>
</div>
</div></div> -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Shamakhi</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 15 / Discover Azerbaijan / Shamakhi: <p>Wine, history and scenic countryside.</p> -->
                            <p>Historic heritage, wine experiences and scenic countryside.</p><a class="link"
                                href="#services">Explore Shamakhi →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Absheron</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 16 / Discover Azerbaijan / Absheron: <p>Caspian coast, fire temples and distinctive landscapes.</p> -->
                            <p>Caspian coast, ancient fire temples and extraordinary landscapes.</p><a class="link"
                                href="#services">Explore Absheron →</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section light" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>Azerbaijan Destinations</h2>
            </div>
            <div class="feature">
                <div class="feature-main"
                    style="background-image:url('assets/images/azerbaijan-city.webp') !important; background-size:cover !important; background-position:center center !important;">
                    <div class="feature-copy">
                        <h2>Baku</h2>
                        <p>A stylish Caspian capital blending old and new.</p><a class="link" href="#services">Discover
                            Baku →</a>
                    </div>
                </div>
                <div class="feature-stack">
                    <div class="feature-small"
                        style="background-image:url('assets/images/azerbaijan-qabala.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <div class="feature-copy">
                            <!-- OLD CONTENT — Azerbaijan Excel row 17 / Azerbaijan Destinations card heading Qabala/Gabala: <h3>Qabala</h3> -->
                            <h3>Qabala / Gabala</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 17 / Azerbaijan Destinations / Qabala: <p>A mountain escape suited to leisure, family and adventure.</p> -->
                            <p>A mountain escape combining nature, resorts, adventure and family experiences.</p><a
                                class="link" href="#services">Discover Qabala →</a>
                        </div>
                    </div>
                    <div class="feature-small"
                        style="background-image:url('assets/images/azerbaijan-silk-road.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <div class="feature-copy">
                            <h3>Sheki</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 18 / Azerbaijan Destinations / Sheki: <p>A historic destination rich in architecture, crafts and food.</p> -->
                            <p>A captivating Silk Road town rich in architecture, crafts and cuisine.</p><a class="link"
                                href="#services">Discover Sheki →</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="uae-showcase-head">
                <div>
                    ...
                    <h2>Experience Azerbaijan Your Way</h2>
                </div>
                <p>From sophisticated city experiences and mountain escapes to ancient heritage, local flavours and
                    Caspian adventures, shape Azerbaijan around what your clients want to discover.</p>
            </div>
            <div class="uae-exp-grid-redesign">
                <article class="uae-exp-card uae-exp-card-wide" data-aos="fade-up" data-aos-delay="40">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/azerbaijan-city-luxury.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">01</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Urban Sophistication</span>
                        <h3>City &amp; Luxury</h3>
                        <p>Private touring, exceptional dining and sophisticated Caspian experiences.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="80">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/experience-adventure.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">02</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Scenic Journeys</span>
                        <h3>Mountain Escapes</h3>
                        <p>Mountain resorts, cable cars and spectacular Caucasus scenery.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="120">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/azerbaijan-culture-heritage.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">03</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Stories &amp; Tradition</span>
                        <h3>Culture &amp; Heritage</h3>
                        <p>Old City, palaces, museums and fascinating Silk Road history.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="160">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/azerbaijan-family-experience.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">04</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Shared Memories</span>
                        <h3>Family Experiences</h3>
                        <p>Cable cars, parks and engaging experiences for every age.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="200">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/azerbaijan-adventure-experience.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">05</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Outdoor Thrills</span>
                        <h3>Adventure</h3>
                        <p>Hiking, mountain activities and immersive outdoor exploration.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="240">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/azerbaijan-culinary-journeys-v2.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">06</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Dining &amp; Taste</span>
                        <h3>Culinary Journeys</h3>
                        <p>Azerbaijani flavours, local markets and memorable tasting experiences.</p>
                    </div>
                </article>
            </div>
        </div>
    ...
    <section class="section light" data-aos="fade-up" data-aos-duration="850" id="services">
        <div class="container">
            <div class="heading">
                ...
                <h2>Azerbaijan DMC Services, Built Around Your Brief</h2>
                <!-- OLD CONTENT — Azerbaijan Excel row 26 / Azerbaijan DMC Services intro: <p>From itinerary planning and accommodation to MICE, transportation, experiences and on-ground coordination, our Azerbaijan DMC services bring every element together seamlessly.</p> -->
                <p>From bespoke city breaks and mountain escapes to luxury travel, groups and MICE, our Azerbaijan DMC
                    team brings together local expertise, trusted partners and seamless destination operations.</p>
            </div>
            <div class="services row g-3">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>FIT Travel</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 27 / Azerbaijan DMC Services / FIT Travel: <p>Tailored individual travel programs.</p> -->
                        <p>Bespoke Azerbaijan journeys tailored to individual travellers.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Group Travel</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 28 / Azerbaijan DMC Services / Group Travel: <p>Seamless group handling and logistics.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>MICE</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 29 / Azerbaijan DMC Services / MICE: <p>Meetings, incentives and events.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 30 / Azerbaijan DMC Services / Corporate Travel: <p>Business travel and corporate movements.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Luxury Travel</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 31 / Azerbaijan DMC Services / Luxury Travel: <p>Premium stays and private experiences.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 32 / Azerbaijan DMC Services / Family Holidays: <p>Family itineraries and attractions.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Honeymoon</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 33 / Azerbaijan DMC Services / Honeymoon: <p>Romantic escapes and private experiences.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Stopovers</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 34 / Azerbaijan DMC Services / Stopovers: <p>Short programs for transit travelers.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Hotels</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 35 / Azerbaijan DMC Services / Hotels: <p>Accommodation sourcing and reservations.</p> -->
                        <p>Exceptional hotels and resorts, sourced around your brief.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Transfers</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 36 / Azerbaijan DMC Services / Transfers: <p>Airport and regional transfers.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Excursions</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 37 / Azerbaijan DMC Services / Excursions: <p>Tours, sightseeing and activities.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 38 / Azerbaijan DMC Services / Visa & Entry Support: <p>Travel documentation and destination guidance.</p> -->
    ...
    <section class="section" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>Azerbaijan Itineraries, Made Your Way</h2>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="itinerary h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="body"><span class="duration">3 Days</span>
                            <h3>Baku Highlights</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 40 / Sample Azerbaijan Itineraries / Baku Highlights: <p>Old City, waterfront, architecture and local cuisine.</p> -->
                            <p>Old City, Caspian waterfront, striking architecture and local flavours.</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="itinerary h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="body"><span class="duration">5 Days</span>
                            <!-- OLD CONTENT — Azerbaijan Excel row 41 / Itinerary heading Qabala/Gabala: <h3>Baku + Qabala</h3> -->
                            <h3>Baku + Qabala/ Gabala</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 41 / Sample Azerbaijan Itineraries / Baku + Qabala: <p>City discovery paired with mountain scenery and leisure.</p> -->
                            <p>Baku’s energy paired with mountain scenery and leisurely escapes.</p>
                            <a class="itinerary-card-cta" href="contact.php">Send Query →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="itinerary h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="body"><span class="duration">7 Days</span>
                            <h3>Azerbaijan Discovery</h3>
                            <!-- OLD CONTENT — Azerbaijan Excel row 42 / Sample Azerbaijan Itineraries / Azerbaijan Discovery: <p>Baku, Gobustan, Qabala and historic Sheki.</p> -->
                            <p>Baku, Gobustan, Gabala and historic Sheki, thoughtfully brought together.</p>
                            <a class="itinerary-card-cta" href="contact.php">Send Query →</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="uae-showcase-head uae-movement-head">
                <div>
                    ...
                    <h2>Seamless Movement, City To Mountains</h2>
                </div>
                <p>From Baku arrivals and private touring to mountain escapes and regional journeys, we coordinate every
                    connection across Azerbaijan.</p>
            </div>
            <div aria-label="Azerbaijan transportation journey" class="uae-route">
                ...
                <div class="uae-route-stop">
                    ...
                    <p>Seamless connections between Azerbaijan’s key destinations.</p>
                </div>
                <div class="uae-route-stop">
    ...
    <section class="section dark" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <!-- OLD CONTENT — Azerbaijan Excel row 50 / Your Azerbaijan DMC Partner intro: <p>From the first brief to the final departure, Voyage 1 combines local Azerbaijan destination expertise, customized programs and seamless operations to help travel partners deliver with confidence.</p> -->
                <p>From the first brief to the final departure, Voyage 1 combines Azerbaijan destination expertise,
            ...
            <div class="usps row g-3">
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <h3>Local Azerbaijan Expertise</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 51 / Your Azerbaijan DMC Partner / Local Azerbaijan Expertise: <p>Local knowledge and coordination.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 52 / Your Azerbaijan DMC Partner / Customized Itineraries: <p>Programs shaped around your clients.</p> -->
                        <p>Azerbaijan programs shaped around your clients’ needs.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 53 / Your Azerbaijan DMC Partner / FIT & Group Expertise: <p>Flexible FIT and group handling.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 54 / Your Azerbaijan DMC Partner / MICE Capability: <p>Corporate events and incentives.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 55 / Your Azerbaijan DMC Partner / Reliable Suppliers: <p>Hotels, transport and experiences.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Azerbaijan Excel row 56 / Your Azerbaijan DMC Partner / Seamless Operations: <p>One partner managing every detail.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <h3>24/7 Support</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 57 / Your Azerbaijan DMC Partner / 24/7 Support: <p>Responsive support throughout the journey.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <h3>B2B Focused</h3>
                        <!-- OLD CONTENT — Azerbaijan Excel row 58 / Your Azerbaijan DMC Partner / B2B Focused: <p>Built for travel agents and operators.</p> -->
        ...
        <div class="container">
            <div class="uae-process-intro">
                <div>
                    ...
                    <h2>Plan Your Azerbaijan Journey</h2>
            ...
            <div class="uae-process-rail">
                ...
                <article class="uae-process-step">
                    ...
                    <p>Share your Azerbaijan brief, traveller profile and priorities with us.</p>
                </article>
                <article class="uae-process-step">
    ...
    <section class="section" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>Azerbaijan DMC FAQs</h2>
                <p>Yes. We create bespoke programs for honeymoons, private celebrations, family journeys and other
                    special occasions across Azerbaijan.</p>
            </div>
            <div class="faq row g-3">
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        <button aria-expanded="false" class="faq-trigger" type="button"><strong>What does a Azerbaijan
                                DMC do?</strong><span aria-hidden="true">+</span></button>
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 63 / Azerbaijan FAQ answer: <p>A Azerbaijan DMC manages the local details behind an itinerary, including hotels, transportation, experiences, guides, logistics and on-ground support.</p> -->
                            <p>An Azerbaijan DMC manages the local details behind an itinerary, including hotels,
                ...
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 64 / Azerbaijan FAQ answer: <p>Yes. We create tailored FIT programs as well as coordinated group journeys, with the flexibility to match each client brief.</p> -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        <button aria-expanded="false" class="faq-trigger" type="button"><strong>Can you create
                                customized Azerbaijan itineraries?</strong><span aria-hidden="true">+</span></button>
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 65 / Azerbaijan FAQ answer: <p>Absolutely. We shape itineraries around dates, interests, traveller profiles, preferred hotels, experiences and budget.</p> -->
                            <p>Absolutely. We shape Azerbaijan itineraries around dates, interests, traveller profiles,
                ...
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 66 / Azerbaijan FAQ answer: <p>Yes. Our team can coordinate venues, accommodation, transportation, incentives, event logistics and on-ground event support.</p> -->
                            <p>Yes. We coordinate venues, accommodation, transportation, incentives, event logistics and
                                on-ground support for Azerbaijan MICE programs.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 67 / Azerbaijan FAQ answer: <p>We coordinate airport transfers, private vehicles, coaches and inter-city transportation throughout Azerbaijan.</p> -->
                            <p>We source suitable hotels and resorts and coordinate airport transfers, private vehicles,
                                group transportation and regional travel across Azerbaijan.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        <button aria-expanded="false" class="faq-trigger" type="button"><strong>Which parts of
                                Azerbaijan do you operate in?</strong><span aria-hidden="true">+</span></button>
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 68 / Azerbaijan FAQ answer: <p>We support programs across Baku, Gobustan, Gabala, Sheki, Quba, Shahdag, Ganja and other key regions based on the itinerary.</p> -->
                            <p>We can build programs across Azerbaijan, including Baku, Gabala, Sheki, Gobustan,
                                Shamakhi and the Absheron region.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 69 / Azerbaijan FAQ answer: <p>Yes. We curate premium stays, private experiences, luxury transportation and special moments around the traveller.</p> -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Azerbaijan Excel row 70 / Azerbaijan FAQ answer: <p>Yes. We can arrange curated experiences and celebration programs, including honeymoons, private occasions, family travel and other bespoke requests.</p> -->
                            <p>Yes. We create bespoke programs for honeymoons, private celebrations, family journeys and
                                other special occasions across Azerbaijan.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section dark" data-aos="fade-up" data-aos-duration="850" id="contact">
        <div class="container contact">
            <div>
                ...
                <h2>Let's Plan Your Azerbaijan Program</h2>
...
<?php include "form.php" ?>
            ...
            <!-- <form data-destination="Azerbaijan" data-subject="Azerbaijan Journey Enquiry — Voyage 1"
                id="uae-enquiry-form">
                ...
                <div class="form-field"><label for="uae-destination">Preferred City / Region</label><select
                        ...
                        <option>Quba</option>
                        <option>Gobustan</option>
                        <option>Shahdag</option>
                        <option>Ganja</option>
                        <option>Multi-city Azerbaijan</option>
                    </select></div>
                ...
                <div class="form-actions">
                    <p class="form-note">We’ll use these details only to prepare your Azerbaijan proposal.</p><button
