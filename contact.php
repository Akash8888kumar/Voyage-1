...
<head>
    ...
    <title>Contact Us | Voyage 1 DMC</title>
    <meta
        content="Have a journey in mind? Whether it's a tailor-made escape, group program, MICE experience or a new destination opportunity, connect with the Voyage 1 team."
        name="description" />
...
<body class="page-contact">
    <!-- COPY AUDIT UPDATE: Active copy sourced from Voyage_1_copy_all_pages (1).xlsx, sheet "Copy Audit" for Contact Us. Previous replaced copy is preserved inline as OLD CONTENT comments. -->
            ...
            <div class="container"><a aria-label="Voyage 1 home" class="navbar-brand vo-brand" href="index.php"><img
                ...
                <div class="collapse navbar-collapse" id="voyageNavbar">
                    <ul class="navbar-nav ms-auto align-items-lg-center">
                        ...
                        class="btn vo-header-cta ms-lg-4 mt-3 mt-lg-0 active d-inline-flex align-items-center justify-content-center"
    ...
    <section class="hero" data-aos="fade-up" data-aos-duration="850">
        ...
        <div class="c container">
            <div class="ey">Contact Voyage 1</div>
            <h1>Let's Plan<br />What's Next.</h1>
            <p>Have a journey in mind? Whether it’s a tailor-made escape, group program, MICE experience or a new
                destination opportunity, connect with our team and let’s turn your brief into something exceptional.</p>
        </div>
    </section>
    <section class="sec" data-aos="fade-up" data-aos-duration="850" id="query">
        <div class="c grid container">
            <div class="intro">
                <div class="ey">Start A Conversation</div>
                <h2>Have A Journey<br />In Mind?</h2>
                <p class="lead">Tell us what you're looking for. Our destination team will help shape the right solution
                    for your clients.</p>
                <div class="details">
                    <div class="detail global-enquiries-detail" data-aos="fade-up" data-aos-duration="750"
                        data-aos-once="true"><small>Global Enquiries</small><b><a href="tel:+971521672038">+971 52 167
                                2038</a><br /><a href="tel:+91921758633">+91 921758633</a></b></div>
                    <div class="detail" data-aos="fade-up" data-aos-duration="750" data-aos-once="true">
                        <small>Email</small><b>info@voyage-one.com</b></div>
                    <div class="detail" data-aos="fade-up" data-aos-duration="750" data-aos-once="true"><small>Global
                            Office</small><b>Dubai, UAE</b></div>
                </div>
            </div>

<form class="form" id="contact-enquiry-form">
    ...
    <div class="formfoot">
        ...
        <span>
            Your enquiry will reach the relevant destination team.
        </span>
    ...
    ></div>
            ...
            <!-- <form class="form" id="contact-enquiry-form">
                <h3>Send Us Your Query</h3>
                <div class="fields">
                    <div class="field"><label for="first-name">First Name *</label><input autocomplete="given-name"
                            class="form-control" id="first-name" name="first_name" required="" /></div>
                    <div class="field"><label for="last-name">Last Name *</label><input autocomplete="family-name"
                            class="form-control" id="last-name" name="last_name" required="" /></div>
                    <div class="field"><label for="work-email">Work Email *</label><input autocomplete="email"
                            class="form-control" id="work-email" name="email" required="" type="email" /></div>
                    <div class="field"><label for="contact-number">Contact Number *</label><input autocomplete="tel"
                            class="form-control" id="contact-number" name="phone" required="" type="tel" /></div>
                    <div class="field"><label for="destination">Destination</label><select class="form-select"
                    ...
                    <div class="field"><label for="travel-type">Travel Type</label><select class="form-select"
                            id="travel-type" name="travel_type">
                    ...
                    <div class="field"><label for="pax">Pax</label><input class="form-control" id="pax" min="1"
                            name="pax" type="number" /></div>
                    <div class="field"><label for="travel-dates">Travel Dates</label><input class="form-control"
                            id="travel-dates" name="travel_dates" type="date" /></div>
                    <div class="field full"><label for="requirements">Requirements *</label><textarea
                            class="form-control" id="requirements" name="requirements" required=""></textarea></div>
                </div>
                <div class="formfoot"><span>Your enquiry will reach the relevant destination team.</span><button
                        class="btn dark d-inline-flex align-items-center justify-content-center" type="submit">Send
                        Query →</button></div>
            </form> -->
    ...
    <section class="sec" data-aos="fade-up" data-aos-duration="850">
        <div class="c container">
            <div class="ey">Talk To Our Team</div>
            <h2>Global Support.<br />Local Access.</h2>
            <p>Wherever your clients travel, having the right people nearby makes all the difference. Our destination
                teams bring local knowledge, trusted relationships and responsive support closer to every journey.</p>
            <div class="grid">
                <div class="detail" data-aos="fade-up" data-aos-duration="750" data-aos-once="true">Global
                    Office<br /><b>#73, G Floor, Al Fahidi Plaza Souq Al Kabeer, Dubai, UAE</b></div>
                <div class="detail" data-aos="fade-up" data-aos-duration="750" data-aos-once="true">Phone<br /><b>+971 4
                        2897211<br />+971 52 167 2038</b></div>
                <div class="detail" data-aos="fade-up" data-aos-duration="750" data-aos-once="true">
                    Email<br /><b>info@voyage-one.com</b></div>
                <div class="detail" data-aos="fade-up" data-aos-duration="750" data-aos-once="true">Office
                    Network<br /><b>South Africa · Kenya · Tanzania · Japan · Georgia · Kazakhstan · Azerbaijan · UAE ·
                        Vietnam</b></div>
            </div>
        </div>
    </section>
    <section class="sec" data-aos="fade-up" data-aos-duration="850">
        <div class="c container">
            <div class="ey">Where We Are</div>
            <h2>Local Teams.<br />Global Reach.</h2>
            <div class="office office-network-card">
                <div class="office-map-shell"><iframe aria-label="Voyage 1 South Africa office map"
                        class="office-map-embed" data-office-map-embed="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade"
                        src="https://www.google.com/maps?q=Voyage%201%20DMC%20South%20Africa&amp;output=embed"
                        title="Voyage 1 South Africa office location"></iframe></div>
                <div class="panel office-panel office-panel-integrated" data-office-panel="">
                    <div aria-label="Voyage 1 offices" class="tabs office-tabs-integrated" role="tablist"><button
                            aria-selected="true" class="active" data-office-tab="south-africa" role="tab"
                            type="button">South Africa</button>
                        <button aria-selected="false" data-office-tab="kenya" role="tab" type="button">Kenya</button>
                        <button aria-selected="false" data-office-tab="tanzania" role="tab"
                            type="button">Tanzania</button>
                        <button aria-selected="false" data-office-tab="japan" role="tab" type="button">Japan</button>
                        <button aria-selected="false" data-office-tab="georgia" role="tab"
                            type="button">Georgia</button>
                        <button aria-selected="false" data-office-tab="almaty" role="tab" type="button">Almaty</button>
                        <button aria-selected="false" data-office-tab="baku" role="tab" type="button">Baku</button>
                        <button aria-selected="false" data-office-tab="dubai" role="tab" type="button">Dubai</button>
                        <button aria-selected="false" data-office-tab="vietnam" role="tab"
                            type="button">Vietnam</button>
                    </div>
                    <div aria-live="polite" class="office-detail office-detail-integrated" data-office-detail="">
                        <div class="ey">Destination Office</div>
                        <h2 data-office-name="">South Africa</h2>
                        <p data-office-address="">South Africa destination operations — contact the Voyage 1 team for
                            local office details.</p>
                        <a class="btn d-inline-flex align-items-center justify-content-center" data-office-map=""
                            href="https://maps.google.com/?q=Voyage+1+DMC+South+Africa" rel="noopener"
    ...
    <section class="sec" data-aos="fade-up" data-aos-duration="850">
        <div class="c network container">
            <div>
                <div class="ey">Destination Network</div>
                <h2>One Partner.<br />Multiple Destinations.</h2>
            </div>
            <div>
                <p>From South Africa and Japan to the UAE, Vietnam, Georgia, Azerbaijan and Kazakhstan, our destination
                    network gives travel partners access to local expertise across a growing world of possibilities.</p>
                <div class="list">
    ...
    <section class="sec" data-aos="fade-up" data-aos-duration="850">
        <div class="c container">
            <div class="ey">Why Voyage 1</div>
            <h2>Why Work With Us?</h2>
            <div class="why">
                <div class="card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750"><span>01</span>
                    <div><svg class="card-icon" fill="none" stroke="currentColor" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 24 24">
                            <path d="M12 21s7-6.4 7-11.5A7 7 0 0 0 5 9.5C5 14.6 12 21 12 21Z"></path>
                            <circle cx="12" cy="9.5" r="2.4"></circle>
                        </svg>
                        <h3>Local Expertise</h3>
                        <p>Destination knowledge where it matters.</p>
                    </div>
                </div>
                <div class="card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750"><span>02</span>
                    <div><svg class="card-icon" fill="none" stroke="currentColor" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 24 24">
                            <path d="M13 2 4 14h6l-1 8 9-12h-6l1-8Z"></path>
                        </svg>
                        <h3>Fast Response</h3>
                        <p>A responsive team behind every enquiry.</p>
                    </div>
                </div>
                <div class="card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750"><span>03</span>
                    <div><svg class="card-icon" fill="none" stroke="currentColor" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="1.5" viewbox="0 0 24 24">
                        ...
                        <p>From planning to on-ground operations.</p>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="cta" data-aos="fade-up" data-aos-duration="850">
        <div class="c container">
            <div class="ey">Ready To Begin?</div>
            <h2>Ready To Build The Journey?</h2>
            <p>Tell us where you're going. We'll take care of what happens next.</p><a
                class="btn dark d-inline-flex align-items-center justify-content-center" href="#query">Send A Query
                →</a><a class="btn d-inline-flex align-items-center justify-content-center" href="uae.php">Explore
                Destinations →</a>
        </div>
    </section>
    ...
    form.addEventListener('submit', function (e) {
        ...
        .then(result => {
            ...
            if (result === 'success') {
                ...
                message.style.background = '#dff6e4';
                message.style.color = '#176b2c';
                message.style.border = '1px solid #b7e4c0';
                ...
                message.style.background = '#fde2e2';
                message.style.color = '#a00000';
                message.style.border = '1px solid #f5b5b5';

                message.innerHTML = result || 'Something went wrong. Please try again.';
            }
        ...
        .finally(() => {
            ...
            submitButton.innerHTML = 'Send Query →';
