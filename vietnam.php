...
<head>
    ...
    <title>Vietnam DMC | Voyage 1 DMC</title>
    <meta
        content="As a trusted Vietnam DMC, Voyage 1 delivers local expertise, seamless operations and tailored travel programs for FIT, groups, luxury, MICE and corporate travel across Vietnam."
        name="description" />
    <style>
        .page-vietnam .hero-bg {
            background-image: url('assets/images/vietnam-dmc-hero-banner-new.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .uae-image-dmc {
            background-image: linear-gradient(180deg, rgba(22, 42, 75, .04), rgba(22, 42, 75, .12)), url('assets/images/Vietnam__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-1 {
            background-image: url('assets/images/hero-vietnam.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-2 {
            background-image: url('assets/images/Vietnam__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-3 {
            background-image: url('assets/images/vietnam-coast.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-4 {
            background-image: url('assets/images/vietnam__png.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-5 {
            background-image: url('assets/images/Vietnam__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-6 {
            background-image: url('assets/images/hero-vietnam.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-7 {
            background-image: url('assets/images/vietnam-coast.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-8 {
            background-image: url('assets/images/vietnam__png.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-9 {
            background-image: url('assets/images/Vietnam__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-10 {
            background-image: url('assets/images/vietnam-coast.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-11 {
            background-image: url('assets/images/Vietnam__jpg.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-12 {
            background-image: url('assets/images/hero-vietnam.webp') !important;
            background-size: cover;
            background-position: center;
        }
    ...
    <style>
        ...
        .page-vietnam .uae-image-dmc {
            background-image: linear-gradient(180deg, rgba(22, 42, 75, .04), rgba(22, 42, 75, .12)), url('assets/images/vietnam-partner.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-1 {
            background-image: url('assets/images/vietnam-card1.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-2 {
            background-image: url('assets/images/vietnam-card2.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-3 {
            background-image: url('assets/images/vietnam-card3.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-4 {
            background-image: url('assets/images/Vietnam_Hoi_An_Destination_Card_Ancient_Town_Lanterns.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-5 {
            background-image: url('assets/images/vietnam-card5.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-6 {
            background-image: url('assets/images/vietnam-card6.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .vo-inline-bg-7 {
            background-image: url('assets/images/vietnam-card7.webp') !important;
            background-size: cover;
            background-position: center;
        }

        .page-vietnam .feature-main {
            background-image: url('assets/images/vietnam-card1.webp') !important;
        }

        .page-vietnam .feature-small:nth-child(1) {
            background-image: url('assets/images/vietnam-card2.webp') !important;
        }

        .page-vietnam .feature-small:nth-child(2) {
            background-image: url('assets/images/vietnam-card3.webp') !important;
        }
    </style>
...
<body class="page-destination page-vietnam">
    <!-- VIETNAM COPY UPDATE: Active copy sourced from Voyage_1_copy_all_pages (1).xlsx, sheet "Vietnam", column "Shreya". Previous active copy is preserved inline as OLD CONTENT comments. -->
    ...
    <section class="hero" data-aos="fade-up" data-aos-duration="850">
        ...
        <div class="container">
            <div class="hero-content">
                <div class="eyebrow">Voyage 1 DMC • Vietnam</div>
                <h1><span class="hero-dmc-name">Vietnam DMC</span></h1>
                <!-- OLD CONTENT — Vietnam Excel row 2 / Hero paragraph: <p>Vietnam combines vibrant cities, ancient heritage, dramatic landscapes, tropical coastlines and exceptional cuisine. Voyage 1 creates seamless B2B programs for FIT, groups, families, luxury and MICE travel.</p> -->
                <p>From vibrant cities and ancient heritage to dramatic landscapes, tropical coastlines and exceptional
                    cuisine, Voyage 1 creates seamless Vietnam programs for FIT, groups, luxury, families and MICE.</p>
        ...
        <div class="container two">
            <div class="row g-4 g-lg-5 align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="eyebrow">Vietnam Destination Management</div>
                    <h2>Your Local Partner in Vietnam</h2>
                    ...
                    <p>You know your clients. We know the destination. Together, we turn travel briefs into seamless
                        ...
                        on the ground.</p>
                    <!-- OLD LOCAL PARTNER COPY — <p>From Hanoi and Halong Bay to central Vietnam and the southern coast, our local team coordinates hotels, transportation, guides, experiences and special requests across the country.</p> -->
                    ...
                    <a class="btn btn-dark d-inline-flex align-items-center justify-content-center" href="#contact">Talk
                        to Our Vietnam Team</a>
                </div>
                <div aria-label="Vietnam destination scene" class="placeholder uae-image uae-image-dmc col-12 col-lg-6"
                    role="img"></div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Culture</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 3 / Culture: <p>Historic cities, temples and living traditions.</p> -->
                            <p>Ancient cities, timeless traditions and living heritage.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Nature</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 4 / Nature: <p>Karst landscapes, rice terraces and tropical scenery.</p> -->
                            <p>Dramatic karsts, rice terraces and tropical landscapes.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Luxury</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 5 / Luxury: <p>Boutique stays, cruises and private experiences.</p> -->
                            <p>Boutique stays, private cruises and exceptional experiences.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Family</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 6 / Family: <p>Easy-to-tailor activities and family-friendly attractions.</p> -->
                            <p>Engaging activities and memorable family adventures.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-fifth">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>MICE</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 7 / MICE: <p>Distinctive venues and efficient event logistics.</p> -->
                            <p>Distinctive venues and seamless event experiences.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                <div class="eyebrow">Explore Vietnam</div>
            ...
            <div class="cards row g-4">
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Hanoi</h3>
                            <p>Old Quarter, heritage landmarks and Vietnamese cuisine.</p><a class="link"
                                href="#services">Explore Hanoi →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Ha Long Bay</h3>
                            <p>Iconic limestone islands and overnight cruise experiences.</p><a class="link"
                                href="#services">Explore Ha Long Bay →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Da Nang</h3>
                            <p>Beachfront leisure, modern resorts and easy access to heritage.</p><a class="link"
                                href="#services">Explore Da Nang →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Hoi An</h3>
                            <p>Lantern-lit streets, heritage architecture and local crafts.</p><a class="link"
                                href="#services">Explore Hoi An →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            ...
                            <p>Energetic city life, history, food and shopping.</p><a class="link"
                                href="#services">Explore Ho Chi Minh City →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Sapa</h3>
                            <p>Mountain scenery, rice terraces and cultural experiences.</p><a class="link"
                                href="#services">Explore Sapa →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="card-body" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                            <h3>Phu Quoc</h3>
                            <p>Tropical beaches, resorts and relaxed island escapes.</p><a class="link"
                                href="#services">Explore Phu Quoc →</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section light" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>Vietnam Destinations</h2>
            </div>
            <div class="feature">
                <div class="feature-main"
                    style="background-image:url('assets/images/vietnam-popular-ha-long-bay-v2.webp') !important; background-size:cover !important; background-position:center center !important;">
                    <div class="feature-copy">
                        <h2>Ha Long Bay</h2>
                        <p>A signature Vietnam experience combining nature and cruising.</p><a class="link"
                            href="#services">Discover Ha Long Bay →</a>
                    </div>
                </div>
                <div class="feature-stack">
                    <div class="feature-small"
                        style="background-image:url('assets/images/vietnam-hanoi-popular.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <div class="feature-copy">
                            <h3>Hanoi</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 15 / Hanoi: <p>A characterful capital rich in history, food and culture.</p> -->
                            <p>A captivating capital where history, culture and cuisine meet.</p><a class="link"
                                href="#services">Discover Hanoi →</a>
                        </div>
                    </div>
                    <div class="feature-small"
                        style="background-image:url('assets/images/vietnam-danang-hoian-popular.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <div class="feature-copy">
                            <h3>Da Nang + Hoi An</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 16 / Da Nang + Hoi An: <p>A balanced combination of beaches, resorts and heritage.</p> -->
                            <p>Beachfront escapes paired with timeless heritage and charm.</p><a class="link"
                                href="#services">Discover Da Nang + Hoi An →</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="uae-showcase-head">
                <div>
                    ...
                    <h2>Things to Do in Vietnam</h2>
                </div>
                <p>Make Vietnam personal with curated experiences shaped around every traveller and travel brief.</p>
            </div>
            <div class="uae-exp-grid-redesign">
                <article class="uae-exp-card uae-exp-card-wide" data-aos="fade-up" data-aos-delay="40">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/vietnam-cruise-experience.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">01</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Signature Escape</span>
                        <h3>Cruise Experiences</h3>
                        <p>Overnight cruises through spectacular limestone seascapes.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="80">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/vietnam-luxury-resort.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">02</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Premium Moments</span>
                        <h3>Luxury Experiences</h3>
                        <p>Luxury resorts, private touring and exceptional dining experiences.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="120">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/vietnam-culture-heritage.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">03</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Stories &amp; Tradition</span>
                        <h3>Culture &amp; Heritage</h3>
                        <p>Ancient towns, historic landmarks and living traditions.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="160">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/vietnam-family-experience.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">04</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Shared Memories</span>
                        <h3>Family Experiences</h3>
                        <p>Beaches, attractions and engaging family adventures.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="200">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/vietnam-adventure-experience.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">05</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Outdoor Thrills</span>
                        <h3>Adventure</h3>
                        <p>Trekking, cycling, caves and unforgettable outdoor exploration.</p>
                    </div>
                </article>
                <article class="uae-exp-card" data-aos="fade-up" data-aos-delay="240">
                    <div class="uae-exp-card-media"
                        style="background-image:url('assets/images/vietnam-culinary-journey.webp') !important; background-size:cover !important; background-position:center center !important;">
                        <span class="uae-exp-card-num">06</span>
                    </div>
                    <div class="uae-exp-card-body">
                        <span class="uae-exp-card-tag">Dining &amp; Taste</span>
                        <h3>Culinary Journeys</h3>
                        <p>Street food, cooking classes and flavours across Vietnam.</p>
                    </div>
                </article>
            </div>
        </div>
    ...
    <section class="section light" data-aos="fade-up" data-aos-duration="850" id="services">
        <div class="container">
            <div class="heading">
                ...
                <h2>Vietnam DMC Services</h2>
                <p>From itinerary planning and accommodation to MICE, transportation, experiences and on-ground
                    coordination, our Vietnam DMC services bring every element together seamlessly.</p>
            </div>
            <div class="services row g-3">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>FIT Travel</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 23 / FIT Travel: <p>Tailored individual travel programs.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Group Travel</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 24 / Group Travel: <p>Seamless group handling and logistics.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>MICE</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 25 / MICE: <p>Meetings, incentives and events.</p> -->
                        <p>Meetings, incentives and memorable events.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 26 / Corporate Travel: <p>Business travel and corporate movements.</p> -->
                        <p>Business travel, movements and local coordination.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Luxury Travel</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 27 / Luxury Travel: <p>Premium stays and private experiences.</p> -->
                        <p>Luxury stays, private experiences and access.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 28 / Family Holidays: <p>Family itineraries and attractions.</p> -->
                        <p>Family journeys filled with discovery.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Honeymoon</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 29 / Honeymoon: <p>Romantic escapes and private experiences.</p> -->
                        <p>Romantic escapes and intimate experiences.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Stopovers</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 30 / Stopovers: <p>Short programs for transit travelers.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Hotels</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 31 / Hotels: <p>Accommodation sourcing and reservations.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Transfers</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 32 / Transfers: <p>Airport and regional transfers.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <h3>Excursions</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 33 / Excursions: <p>Tours, sightseeing and activities.</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="service h-100"><span aria-hidden="true" class="service-icon"><svg fill="none"
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 34 / Visa & Entry Support: <p>Travel documentation and destination guidance.</p> -->
                        <p>Entry guidance and travel documentation support.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>Sample Vietnam Itineraries</h2>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="itinerary h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        <div class="img vo-inline-bg-9"
                            style="background-image:url('assets/images/vietnam-coast.webp') !important; background-size:cover !important; background-position:center center !important;">
                        </div>
                        <div class="body"><span class="duration">4 Days</span>
                            <h3>Hanoi + Ha Long Bay</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 35 / Hanoi + Ha Long Bay: <p>Capital highlights followed by an overnight bay cruise.</p> -->
                            <p>Capital discoveries followed by an unforgettable overnight bay cruise.</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="itinerary h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="body"><span class="duration">6 Days</span>
                            <h3>Hanoi + Central Vietnam</h3>
                            <!-- OLD CONTENT — Vietnam Excel row 36 / Hanoi + Central Vietnam: <p>Hanoi, Da Nang and Hoi An for a balanced first journey.</p> -->
                            <p>Hanoi, Da Nang and Hoi An for culture, coastlines and heritage.</p>
                            <a class="itinerary-card-cta" href="contact.php">Send Query →</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="itinerary h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <div class="body"><span class="duration">9 Days</span>
                            ...
                            <!-- OLD CONTENT — Vietnam Excel row 37 / Vietnam Discovery: <p>Hanoi, Ha Long Bay, Hoi An, Ho Chi Minh City and leisure.</p> -->
                            <p>Hanoi, Ha Long Bay, Hoi An, Ho Chi Minh City and coastal escapes.</p>
                            <a class="itinerary-card-cta" href="contact.php">Send Query →</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="section uae-movement-redesign" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="uae-showcase-head uae-movement-head">
                ...
                <p>Smooth connections across Vietnam.</p>
            </div>
            <div aria-label="Vietnam transportation journey" class="uae-route">
                ...
                <div class="uae-route-stop">
                    ...
                    <div class="uae-route-icon">↗</div>
                    <h3>Private Cars</h3>
                    <p>Comfortable private travel, tailored to itineraries.</p>
                </div>
                <div class="uae-route-stop">
                    <div class="uae-route-node">03</div>
                    <div class="uae-route-icon">◇</div>
                    <h3>Luxury Vehicles</h3>
                    <p>Premium chauffeur-driven journeys in comfort.</p>
                </div>
                <div class="uae-route-stop">
                ...
                <div class="uae-route-stop">
                    ...
                    <p>Seamless connections across Vietnam’s key destinations.</p>
                </div>
                <div class="uae-route-stop">
    ...
    <section class="section dark" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>Your Vietnam DMC Partner</h2>
                <p>From the first brief to the final departure, Voyage 1 combines local Vietnam destination expertise,
                    customized programs and seamless operations to help travel partners deliver with confidence.</p>
            </div>
            <div class="usps row g-3">
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <h3>Local Vietnam Expertise</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 44 / Local Vietnam Expertise: <p>Local knowledge and coordination.</p> -->
                        <p>Destination insight, local relationships and know-how.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 45 / Customized Itineraries: <p>Programs shaped around your clients.</p> -->
                        <p>Journeys shaped around your clients’ interests.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 46 / FIT & Group Expertise: <p>Flexible FIT and group handling.</p> -->
                        <p>Flexible handling for FITs and groups.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 47 / MICE Capability: <p>Corporate events and incentives.</p> -->
                        <p>Meetings, incentives and events, expertly delivered.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 48 / Reliable Suppliers: <p>Hotels, transport and experiences.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <!-- OLD CONTENT — Vietnam Excel row 49 / Seamless Operations: <p>One partner managing every detail.</p> -->
                        <p>Every detail coordinated by one team.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <h3>24/7 Support</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 50 / 24/7 Support: <p>Responsive support throughout the journey.</p> -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="usp h-100" data-aos="fade-up" data-aos-delay="80" data-aos-duration="750">
                        ...
                        <h3>B2B Focused</h3>
                        <!-- OLD CONTENT — Vietnam Excel row 51 / B2B Focused: <p>Built for travel agents and operators.</p> -->
        ...
        <div class="container">
            <div class="uae-process-intro">
                <div>
                    ...
                    <h2>Plan Your Vietnam Journey</h2>
            ...
            <div class="uae-process-rail">
                ...
                <article class="uae-process-step">
                    ...
                    <p>Share your Vietnam brief, traveller profile and priorities with us.</p>
                </article>
                <article class="uae-process-step">
                ...
                <article class="uae-process-step">
                    ...
                    <p>Our destination team confirms partners, bookings and every moving detail.</p>
                </article>
                <article class="uae-process-step">
                    <div class="uae-process-num">04</div>
                    <div class="uae-process-icon">◇</div>
                    <h3>Travel With Confidence</h3>
                    <p>Enjoy reliable on-ground support from arrival through final departure.</p>
                </article>
            </div>
        </div>
    </section>
    <section class="section" data-aos="fade-up" data-aos-duration="850">
        <div class="container">
            <div class="heading">
                ...
                <h2>Vietnam DMC FAQs</h2>
                <p>Yes. We create bespoke programs for honeymoons, private celebrations, family journeys and other
                    special occasions across Vietnam.</p>
            </div>
            <div class="faq row g-3">
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        <button aria-expanded="false" class="faq-trigger" type="button"><strong>What does a Vietnam DMC
                                do?</strong><span aria-hidden="true">+</span></button>
                        <div class="faq-answer">
                            <p>A Vietnam DMC manages the local details behind an itinerary, including hotels,
                ...
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Vietnam Excel row 57 / FAQ Does Voyage 1 handle FIT and group travel?: <p>Yes. We create tailored FIT programs as well as coordinated group journeys, with the flexibility to match each client brief.</p> -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        <button aria-expanded="false" class="faq-trigger" type="button"><strong>Can you create
                                customized Vietnam itineraries?</strong><span aria-hidden="true">+</span></button>
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Vietnam Excel row 58 / FAQ Can you create customized Vietnam itineraries?: <p>Absolutely. We shape itineraries around dates, interests, traveller profiles, preferred hotels, experiences and budget.</p> -->
                            <p>Absolutely. We shape Vietnam itineraries around dates, interests, traveller profiles,
                                preferred hotels, experiences and budget.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Vietnam Excel row 59 / FAQ Does Voyage 1 provide MICE services?: <p>Yes. Our team can coordinate venues, accommodation, transportation, incentives, event logistics and on-ground event support.</p> -->
                            <p>Yes. We coordinate venues, accommodation, transportation, incentives, event logistics and
                                on-ground support for Vietnam MICE programs.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Vietnam Excel row 60 / FAQ Can you arrange hotels and transportation?: <p>We coordinate airport transfers, private vehicles, coaches and domestic transportation throughout Vietnam.</p> -->
                            <p>We source suitable accommodation and coordinate airport transfers, private vehicles,
                                group transportation and intercity travel across Vietnam.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        <button aria-expanded="false" class="faq-trigger" type="button"><strong>Which parts of Vietnam
                                do you operate in?</strong><span aria-hidden="true">+</span></button>
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Vietnam Excel row 61 / FAQ Which destinations do you cover in Vietnam?: <p>We support programs across Hanoi, Ha Long Bay, Sapa, Da Nang, Hoi An, Ho Chi Minh City, Nha Trang, Phu Quoc and other key regions.</p> -->
                            <p>We can build programs across Vietnam, including Hanoi, Ha Long Bay, Da Nang, Hoi An, Ho
                                Chi Minh City, Sapa and Phu Quoc.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Vietnam Excel row 62 / FAQ Can you arrange luxury travel programs?: <p>Yes. We curate premium stays, private experiences, luxury transportation and special moments around the traveller.</p> -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="faq-item h-100">
                        ...
                        <div class="faq-answer">
                            <!-- OLD CONTENT — Vietnam Excel row 63 / FAQ Can you support special experiences and celebrations?: <p>Yes. We can arrange curated experiences and celebration programs, including honeymoons, private occasions, family travel and other bespoke requests.</p> -->
                            <p>Yes. We create bespoke programs for honeymoons, private celebrations, family journeys and
                                other special occasions across Vietnam.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section dark" data-aos="fade-up" data-aos-duration="850" id="contact">
        <div class="container contact">
            <div>
                ...
                <h2>Let's Plan Your Vietnam Program</h2>
...
<?php include "form.php" ?>
            ...
            <!-- <form data-destination="Vietnam" data-subject="Vietnam Journey Enquiry — Voyage 1" id="uae-enquiry-form">
                ...
                <div class="form-field"><label for="uae-destination">Preferred City / Region</label><select
                        ...
                        <option>Sapa</option>
                        <option>Multi-city Vietnam</option>
                    </select></div>
                ...
                <div class="form-actions">
                    <p class="form-note">We’ll use these details only to prepare your Vietnam proposal.</p><button
